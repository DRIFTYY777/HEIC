        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(child:  Text('part of',style: TextStyle(fontStyle: FontStyle.italic,fontSize: 12),)),
              Center(child: Image.asset('assets/mad_lab_logo_sticker.png',width: 150,height: 150,))
            ],
          ),
        ),
      ),
